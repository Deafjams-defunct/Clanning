//
//  CLFeatureRequestWindowController.m
//  Clanning
//
...
@implementation CLFeatureRequestWindowController

@synthesize featureText;
...
- (IBAction)submit:(id)sender {
    ...
    NSString *urlString = [NSString stringWithFormat:@"http://deafjams.com/clanning/report.php?subject=Feature Request&message=%@", featureText.stringValue];
